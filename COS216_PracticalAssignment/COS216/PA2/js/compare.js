...
var orderBy = "ASC";
var searchInputs = ["", "", "", "", "", "", "", "", "", ""];
function setCar(make, model, year_from, transmission,body_type, max_speed_km_per_h, engine_type, number_of_cylinders, drive_wheels, number_of_seats, search)
{
...
function fillSearch(make, model, search, id_trim)
{
...
function getCar(id, search)
{
    ...
    var data = 
    {
        ...
        "return": 
        [
            "make", "model", "year_from", "transmission", "body_type", "max_speed_km_per_h", "engine_type", "number_of_cylinders", "drive_wheels", "number_of_seats", "id_trim"
        ]
    };
